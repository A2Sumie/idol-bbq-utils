...
abstract class BaseProcessor extends BaseCompatibleModel {
    ...
    protected PROCESS_PROMPT = `现在你是一个翻译。目标语言必须是简体中文（zh-CN）。接下来会给你日语或英语，请翻译为简体中文，只输出译文，不要输出原文、繁体中文、日文或英文解释。如果是带有# hash tag的标签，不需要翻译。如果无法翻译请输出："${PROCESSOR_ERROR_FALLBACK}"`
